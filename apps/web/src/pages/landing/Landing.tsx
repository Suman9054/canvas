    ...
    <div className="min-h-screen bg-slate-900">
      ...
      >
        ...
        >
          <div className="text-2xl font-bold text-white">
            Vector<span className="text-emerald-400">Pro</span>
          </div>
          <button
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            {[
              {
                icon: Palette,
                title: "Smart Tools",
                desc: "AI-powered design assistance",
              },
              {
                icon: Wand2,
                title: "Effects Library",
                desc: "1000+ premium effects",
              },
              {
                icon: Download,
                title: "Quick Export",
                desc: "Multiple format support",
              },
            ].map((feature, index) => (
              <div
                key={index}
          ...
          <button
            onClick={onclick}
            className="group bg-gradient-to-r from-emerald-500 to-cyan-500 text-white text-lg 
